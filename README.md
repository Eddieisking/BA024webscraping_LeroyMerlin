# BA024webscraping_LeroyMerlin.fr

This is a web scraping project that focuses on collecting and analyzing data from [LeroyMerlin.fr](https://www.leroymerlin.fr/). The goal of the project is to extract customer reviews, date, ratings, and product information from the website for further analysis and insights. The project utilizes the Scrapy framework to automate the process of data collection and processing.
...
1. Clone this repository: `git clone https://github.com/Eddieisking/BA024webscraping_LeroyMerlin.fr.git`
...
Contributions to this project are welcome! If you have any suggestions, improvements, or bug fixes, please create an [issue](https://github.com/Eddieisking/BA024webscraping_LeroyMerlin.fr/issues) or submit a pull [request](https://github.com/Eddieisking/BA024webscraping_LeroyMerlin.fr/pulls).
